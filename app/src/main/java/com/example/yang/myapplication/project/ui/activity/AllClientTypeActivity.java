 ...
 * Desc :
 */
public class AllClientTypeActivity extends MvpActivity<MvpBasePresenter> {
    ...
    public static Intent getIntent(Context context, String args) {
        Intent intent = new Intent(context, AllClientTypeActivity.class);
        return intent;
    }
    ...
    private void initRv() {
        ...
        adapter = new ClientTypeAdapter(this, TYPE_ALL);
    ...
    private void initToolbar(ToolbarHolder tbHolder) {
        ...
        tbHolder.ivRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(ClientSearchActivity.getIntent(AllClientTypeActivity.this, "暂无参数"));
            }
        });
